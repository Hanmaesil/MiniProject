	...
	public int NurseMoring1(int month) { // 리턴값을 줘서 그 리턴값에 맞게 체력이나 저항력 증가 및 감소
		...
		if (month == 1 || month == 2 || month == 4 || month == 5 || month == 7 || month == 8 || month == 11) {
			...
			if (select == 0) {
				...
				System.out.println("체력이 "); // 메인출력문에 넣자 //체력감소
			} else if (select == 1) {
				System.out.println("출근하는 길에 귀여운 고양이를 봤다");
				System.out.println("기분이 좋아져서 면역력 "); // 저항력 증가
			} else if (select == 2) {
				System.out.println("출근하려는데 원장님을 만났다");
				System.out.print("원장님이 차를 타고 가 체력이 "); // 체력 증가
			}
			return select;
	...
	public int NurseMoring2(int month) {
		...
		if (month == 1 || month == 2 || month == 4 || month == 5 || month == 7 || month == 8 || month == 11) {
			...
			if (select == 0) {
				...
				System.out.println("기분이 좋아져서 면역력  "); // 면역력 증가
			} else if (select == 2) {
	...
	public int NurseMoring3(int month) {
		...
		if (month == 1 || month == 2 || month == 4 || month == 5 || month == 7 || month == 8 || month == 11) {
			...
			if (select == 0) {
				...
				System.out.println("면역력 증가"); // 면역력 증가
			} else if (select == 1) {
				...
				System.out.println("피로가 싹풀려서 체력 "); // 체력 증가
			}
			return select;
		} else if (month == 3 || month == 6 || month == 9) {
			if (select == 0) {
	...
	public int NurseLaunch2(int month) {
		...
		if (month == 1 || month == 2 || month == 4 || month == 5 || month == 7 || month == 8 || month == 11) {
			...
			if (select == 0) {
				...
				System.out.println("피곤해 체력 ");// 체력 감소
			}
			return select;
		} else if (month == 3 || month == 6 || month == 9) {
			if (select == 0) {
	...
	public int NurseLaunch3(int month) {
		...
		if (month == 1 || month == 2 || month == 4 || month == 5 || month == 7 || month == 8 || month == 11) {
			...
			if (select == 0) {
				...
				System.out.println("기분 최고조 면역력 "); // 저항력 증가
			} else if (select == 1) {
	...
	public int AthleteMorning1(int month) {
		...
		if (month == 1 || month == 2 || month == 4 || month == 5 || month == 7 || month == 8 || month == 11) { // 이벤트 없는
			...
			if (select == 0) {
				...
				System.out.println("운동으로 인한 체력 "); // 체력 증가
			} else if (select == 1) {
				System.out.println("빈속에 무리를 했나...");
				System.out.println("속이 아파서 면역력 "); // 저항력 감소
			} else if (select == 2) {
				System.out.println("운동에 너무 심취해서 점심시간 전에 출근했다...");
				System.out.println("주위의 따가운 눈초리에 면역력"); // 면역력 감소
			}
			return select;
			...
			if (select == 0) {
				...
				System.out.println("우어어어어!!!"); // 면역력 증가
			}
			return select;
		} else {
			return select;
	...
	public int AthleteMorning2(int month) {
		...
		if (month == 1 || month == 2 || month == 4 || month == 5 || month == 7 || month == 8 || month == 11) { // 이벤트 없는
			...
			if (select == 0) {
				...
				System.out.println("당분간 운동을 못해서 체력 "); // 체력 감소
			} else if (select == 1) {
				System.out.println("시골의 정기를 받았다!!!");
				System.out.println("시골의 정기를 받아 면역력 "); // 면역력 증가
			} else if (select == 2) {
				System.out.println("산책을 가다가 뱀을 마주쳤다!");
				System.out.println("겉은 근육이여도 속은 여린 나..."); // 면역력 감소
			}
			return select;
		} else if (month == 3 || month == 6 || month == 9) { // 사회적 거리두기
			if (select == 0) {
				...
				System.out.println("지킵시다 쫌! "); // 면역력 감소
			} else if (select == 2) {
				System.out.println("산책을 가다가 뱀을 마주쳤다!");
				System.out.println("겉은 근육이여도 속은 여린 나..."); // 면역력 감소
			}
	...
	public int AthleteMorning3(int month) {
		...
		if (month == 1 || month == 2 || month == 4 || month == 5 || month == 7 || month == 8 || month == 11) { // 이벤트 없는
			...
			if (select == 0) {
				...
				System.out.println("든든해서 체력 "); // 체력 증가
			}
			return select;
		} else if (month == 3 || month == 6 || month == 9) { // 사회적 거리두기
			if (select == 0) {
	...
	public int AthleteLaunch1(int month) {
		...
		if (month == 1 || month == 2 || month == 4 || month == 5 || month == 7 || month == 8 || month == 11) { // 이벤트 없는
			...
			if (select == 0) {
				...
				System.out.println("운동을 해서 체력 "); // 체력 증가
			} else if (select == 1) {
				System.out.println("운동을 가려고 했지만 상사와 식당을 가게 되었다.");
				System.out.println("눈치없는 상사 때문에 저항력 "); // 저항력 감소
			} else if (select == 2) {
			...
			if (select == 0) {
				...
				System.out.println("운동을 하고 싶었지만 마스크를 두고왔다.");
				System.out.println("면역력 "); // 면역력 감소
			}
			return select;
		} else {
	...
	public int AthleteLaunch2(int month) {
		...
		if (month == 1 || month == 2 || month == 4 || month == 5 || month == 7 || month == 8 || month == 11) { // 이벤트 없는
			...
			if (select == 0) {
				...
				System.out.println("밥을 안먹어서 체력 "); // 체력 감소
			} else if (select == 1) {
				System.out.println("점심엔 단백질!");
				System.out.println("단백질을 먹어 체력"); // 체력 증가
			} else if (select == 2) {
				System.out.println("상사가 닭가슴살을 뺏어먹었다");
				System.out.println("......ㅡㅡ "); // 면역력 감소 
			}
			return select;
		} else if (month == 3 || month == 6 || month == 9) { // 사회적 거리두기
			if (select == 0) {
	...
	public int AthleteLaunch3(int month) {
		...
		if (month == 1 || month == 2 || month == 4 || month == 5 || month == 7 || month == 8 || month == 11) { // 이벤트 없는
			...
			if (select == 0) {
				...
				System.out.println("주위의 눈초리를 받아 면역력 "); // 면역력 감소
			} else if (select == 2) {
				System.out.println("꿈에서 운동을 하였다!");
				System.out.println("기분이 좋아서 면역력"); // 면역력 증가
			}
			return select;
		} else if (month == 3 || month == 6 || month == 9) { // 사회적 거리두기
			if (select == 0) {
	...
	public int StudentMorning1(int month) {
		...
		if (month == 1 || month == 2 || month == 4 || month == 5 || month == 7 || month == 8 || month == 11) { // 이벤트 없는
			...
			if (select == 0) {
				...
				System.out.println("늦잠을 자서 저항력이 "); // 저항력 증가
			} else if (select == 1) {
				System.out.println("늦잠을 자버려서 한대뿐인 버스를 놓쳤다!");
				System.out.println("학교까지 뛰어가서 체력이"); // 체력 감소
			} else if (select == 2) {
				System.out.println("늦잠자다가 급하게 준비하다가 문턱에 발가락을 찧었다!");
				System.out.println("겁나 아파..."); // 체력 감소
			}
			return select;
		} else if (month == 3 || month == 6 || month == 9) { // 사회적 거리두기
			if (select == 0) {
				...
				System.out.println("원격수업 최고! "); // 체력 증가
			} else if (select == 2) {
				System.out.println("늦잠자다가 급하게 준비하다가 문턱에 발가락을 찧었다!");
				System.out.println("겁나 아파..."); // 체력 감소
			}
	...
	public int StudentMorning2(int month) {
		...
		if (month == 1 || month == 2 || month == 4 || month == 5 || month == 7 || month == 8 || month == 11) {
			...
			if (select == 0) {
				...
				System.out.println("밥이 최고! "); // 체력 증가
			} else if (select == 1) {
				System.out.println("학교에 도착했는데 마스크를 잃어버렸다!");
				System.out.println("마스크가 없어 저항력이 "); // 저항력 감소
			} else if (select == 2) {
				System.out.println("학교가는길에 방구차를 만나 소독이 되었다!");
				System.out.println("뿌아아아아앙!!! "); // 저항력 증가
			}
			return select;
		}
			...
			if (select == 0) {
				...
				System.out.println("경찰보고 놀라 저항력이 "); // 저항력 감소
			}
			return select;
		} else {
			return select;
	...
	public int StudentMorning3(int month) {
		...
		if (month == 1 || month == 2 || month == 4 || month == 5 || month == 7 || month == 8 || month == 11) {
			if (select == 0) {
				...
				System.out.println("효심이 가득해 체력과 저항력 "); // 증가
			} else if (select == 1) {
				System.out.println("농사를 도와주다가 야생의 고라니를 만났다!");
				System.out.println("고라니를 보고 심신이 약해서 저항력 "); // 저항력 감소
			} else if (select == 2) {
				System.out.println("농사를 도와주다가 학교에 지각했다!");
				System.out.println("학교까지 뛰어가서 체력 ");// 체력 감소
			}
			return select;
		} else if (month == 3 || month == 6 || month == 9) {
			if (select == 0) {
				...
				System.out.println("잠깐 내렸지만 ");// 저항력 감소
			}
			return select;
		} else {
			return select;
	...
	public int StudentLaunch1(int month) {
		...
		if (month == 1 || month == 2 || month == 4 || month == 5 || month == 7 || month == 8 || month == 11) {
			if (select == 0) {
				...
				System.out.println("식이섬유가 풍부하여 저항력 ");// 저항력 중가.
			} else if (select == 1) {
				System.out.println("맞은편 자리에 교수님이 앉으셨다!");
				System.out.println("체했....."); // 저항력 감소
			} else if (select == 2) {
				System.out.println("학식에 한우가!!!");
				System.out.println("고기이이이이!!!!"); // 체력 증가
			}
			return select;
		} else if (month == 3 || month == 6 || month == 9) {
			if (select == 0) {
				...
				System.out.println("한칸씩 띄어 앉기 필수!! "); // 저항력 감소
			}
			return select;
		} else {
			return select;
	...
	public int StudentLaunch2(int month) {
		...
		if (month == 1 || month == 2 || month == 4 || month == 5 || month == 7 || month == 8 || month == 11) {
			...
			if (select == 0) {
				...
				System.out.println("학교까지 어떻게 가지..."); // 저항력 감소
			} else if (select == 2) {
	...
	public int StudentLaunch3(int month) {
		...
		if (month == 1 || month == 2 || month == 4 || month == 5 || month == 7 || month == 8 || month == 11) {
			...
			if (select == 0) {
				...
				System.out.println("쫒겨나 마음에 상처를 받아 ");// 저항력 감소
			} else if (select == 1) {
				System.out.println("지나가던 교수님이 기특하다고 미리 A+ 를 주셨다");
				System.out.println("기분이 좋아 저항력이 "); // 저항력 증가
			} else if (select == 2) {
	...
	public int StudentNight1(int month) {
		...
		if (month == 1 || month == 2 || month == 4 || month == 5 || month == 7 || month == 8 || month == 11) {
			...
			if (select == 0) {
				...
				System.out.println("방역수칙 안지키니?");
				System.out.println("조심 안하니? "); // 저항력 감소
			}
			return select;
		} else {
			return select;
